...
namespace day_6
{
    class Problem6
    {
        static void Main(string[] args)
        {
            ...
            lp.Details(Laptop.Lenove, Laptop.Price1000, Laptop.i3, Laptop.Ram2GB, Laptop.HD500GB);
            Console.WriteLine("\n\n*************************************\n");

            lp.Details(Laptop.Dell, Laptop.Price1500, Laptop.i5, Laptop.Ram4GB, Laptop.HD1TB);
            Console.WriteLine("\n\n*************************************\n");

            lp.Details(Laptop.Sony, Laptop.Price2000, Laptop.i9, Laptop.Ram8GB, Laptop.HD1TB);
            Console.WriteLine("\n\n*************************************\n");
    ...
    {
        public void Details(string name, string price, string processor, string ram, string hdd)
        {
